...
for j = 0, n_elements(label_list) - 1 do begin
  ...
  if (streak gt 0) then begin
    ...
    plot, timest, st10, psym = 1, xstyle=1, ystyle=1, charsize=csize, $
          ...
          xticks=6,xtickv=[63072063,126230463,189302463,252460863,315532863,378691197,441763197],xminor=12, $
          xtickname=[' 2000:001',' 2002:001',' 2004:001',' 2006:001',' 2008:001', ' 2010:001', ' 2012:001']
