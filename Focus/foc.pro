...
for j = 0, n_elements(label_list) - 1 do begin
  ...
  for i = 0, numlns - 1 do begin
    ...
    if (n_elements(tmp) lt 10) then continue=0
    if (n_elements(tmp) ge 10) then begin
  ...
  if (streak gt 0) then begin
    ...
    plot, timest, st10, psym = 1, xstyle=1, ystyle=1, charsize=csize, $
          ...
          xticks=4,xtickv=[63072063,126230463,189302463,252460863,315532863],xminor=12, $
          xtickname=[' 2000:001',' 2002:001',' 2004:001',' 2006:001',' 2008:001']
